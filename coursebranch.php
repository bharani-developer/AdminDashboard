      ...
      <div class="content-wrapper">
         <div class="content-header ">
            <div class="content-header-left ">
               <div class="row breadcrumbs-top">
                  <div class="breadcrumb-wrapper">
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Course Branch</a>
                        </li>
               ...
               <br>
               <div>
                  <h3 class="content-header-title mb-0">Course Branch</h3>
                  <br>
               </div>
            </div>
                     ...
                     <form class="validate1" action="#" id="curriculum-form" method="POST">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <fieldset class="form-group">
                                    <label for="customSelect">Country<span class="text-danger">*</span></label>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                 <fieldset class="form-group">
                                    <label for="customSelect">City<span class="text-danger">*</span></label>
                                    <select class="custom-select block" id="customSelect">
                                       <option selected>Select</option>
