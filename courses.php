           ...
           <div class="btn-group float-md-right">
             <div class="btn-group" role="group">
               <a href="createcourse.php">
                 <button class="btn btn-outline-primary" id="btnGroupDrop1" type="button" aria-haspopup="true" aria-expanded="false"><i class="ft-plus icon-left"></i> Add Course</button></a>
                       ...
                       <tbody>
                         ...
                         <tr>
                           ...
                           <td>
                             <div class="form-group text-center">
                               <!-- Floating icon button Regular -->
                               <a href="#" class="btn btn-float btn-square btn-primary btn-sm"><i class="fa fa-eye"></i></a>
                               <a href="#" class="btn btn-float btn-square  btn-warning btn-sm"><i class="fa fa-times"></i></a>
                               <a href="#" class="btn btn-float btn-square btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                             </div>
                         </tr>
