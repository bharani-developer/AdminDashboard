       ...
       <div class="content-wrapper">
           <div class="content-header row">
               <div class="content-header-left col-md-12 col-12 mb-2">
                   <div class="row breadcrumbs-top">
                       <div class="breadcrumb-wrapper col-12">
                           <ol class="breadcrumb">
                               ...
                               <li class="breadcrumb-item"><a href="#">Training Slot List</a>
                               </li>
                               <li class="breadcrumb-item active">Training slot Waiting List
                               </li>
                           </ol>
                       </div>
                   </div>
                   <br>
                   <br>
                   <h3 class="content-header-title mb-0">Training slot Waiting List</h3>
               </div>
